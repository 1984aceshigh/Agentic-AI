...
def add_node(workflow_id: str):
    ...
    updated_yaml = get_definition_editor_service().add_node(
        _required_str(payload.get('yaml_text'), 'yaml_text'),
        {
            ...
            'llm_assessment_options': payload.get('llm_assessment_options'),
            'llm_assessment_routes': payload.get('llm_assessment_routes'),
            'llm_extract_fields': payload.get('llm_extract_fields'),
            'llm_extract_output_format': payload.get('llm_extract_output_format'),
